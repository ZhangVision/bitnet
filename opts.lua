...
function M.parse(arg)
   ...
   ---------- Model options ----------------------------------
   cmd:option('-netType',      'bitnet', 'Options: resnet | preresnet')
   cmd:option('-depth',        34,       'BitNet depth: 26 | 34 ', 'number')
   cmd:option('-bdepth',        3,       'BitNet tree depth for cifar', 'number')
   cmd:option('-width',         8,       'BitNet tree width for cifar', 'number')
   cmd:option('-nblock',        2,       'BitNet number of tree blocks for cifar', 'number')
   cmd:option('-testOnTrain',  'false',  'get train error')
   ...
   opt.testOnTrain = opt.testOnTrain ~= 'false'
